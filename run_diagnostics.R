...
system(paste("Rscript --vanilla R_scripts/2_plot_met.R", output_dir), ignore.stdout = TRUE)
print("Finished plotting met forcing")
system(paste("Rscript --vanilla R_scripts/8_plot_Q_P.R", output_dir), ignore.stdout = TRUE)
print("Finished plotting Discharge and P")
system(paste("Rscript --vanilla R_scripts/6_plot_diagnostic_layers.R", output_dir), ignore.stdout = TRUE)
system(paste("Rscript --vanilla R_scripts/7_plot_diagnostic_year.R", output_dir, the_year), ignore.stdout = TRUE)
print("DONE!!")
