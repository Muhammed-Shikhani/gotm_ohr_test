...
p_all <-  ggarrange(plotlist =p_layer, ncol = 1, common.legend = F, legend = "none")

ggsave(filename = paste0( output_dir, "/" , "plot_wholelake.png"),
       plot =  p_all, width = 15, height = 35, dpi = 150, bg = "white")
