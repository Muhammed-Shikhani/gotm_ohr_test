...
plot_dir <- file.path(output_dir, "/3layers/")
indv_dir <- file.path(output_dir, "/3layers/ind_vars/")
...
p_all <-  ggarrange(plotlist =p_layer, ncol = 3, common.legend = F, legend = "none")

ggsave(filename = paste0( output_dir, "/" ,"plot_3layers.png"),
       plot =  p_all, width = 30, height = 35, dpi = 150, bg = "white")
