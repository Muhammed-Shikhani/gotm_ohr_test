...
system(paste("Rscript --vanilla R_scripts/3_plot_3layers.R", output_dir), ignore.stdout = TRUE)
print("Finished plotting at 3 layers 0 11 16 bottom")
system(paste("Rscript --vanilla R_scripts/4_plot_2layers.R", output_dir), ignore.stdout = TRUE)
print("Finished plotting at 2 layers 0 20 bottom")
system(paste("Rscript --vanilla R_scripts/5_plot_wholelake.R", output_dir), ignore.stdout = TRUE)
